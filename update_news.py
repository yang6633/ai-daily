...
def summarize_with_ai(news_list):
    ...
    prompt = f"""从以下AI科技新闻中筛选出10条最热门、最有话题性、最吸引眼球的新闻，可以是有争议的、令人惊讶的、引发讨论的，不要只选严肃正规的新闻。

{news_text}

要求：
1. 标题要吸引眼球、有悬念感、能引发点击和讨论
2. 可以是争议性新闻、突发事件、热门话题
3. 50字以内的摘要
4. 每条新闻必须有50字以内的AI解读，要有趣、有观点，可以犀利点评
5. 必须包含真实URL
6. 返回JSON数组格式（每条都要有analysis字段）：
[{{"rank":1,"title":"吸引人的标题","summary":"摘要","analysis":"AI犀利点评","source":"来源","url":"链接"}}]
